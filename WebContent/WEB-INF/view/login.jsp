	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form:form action="checkCustomer" modelAttribute="customer" method="POST" class="login100-form validate-form">
				...
				<center><input type="button" value="Not have account click here" onClick="window.location.href='signup'; return false;" class="btn btn-success"/>
					</center>
			</div>
		</div>
	</div>
