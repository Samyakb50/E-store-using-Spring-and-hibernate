...
<header class="header-section">
        ...
        <div class="nav-item">
            <div class="container">
                ...
                <nav class="nav-menu mobile-menu">
                    <ul>
                        <li class="active"><a href="${pageContext.request.contextPath}/product/home">Home</a></li>
                        <li><a href="./contact.html">About</a></li>
                        
                        <li><a href="./contact.html">Contact</a></li>
                        <li><a href="${pageContext.request.contextPath}/customer/login">User login</a></li>
                        <li><a href="${pageContext.request.contextPath}/customer/login2">Admin login</a></li>
    ...
    <section class="hero-section">
        <div class="hero-items owl-carousel">
            <div class="single-hero-items set-bg" data-setbg="${pageContext.request.contextPath}/resources/img6/hero-1.jpg">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-5">
                            <span>Bag,kids</span>
            ...
            <div class="single-hero-items set-bg" data-setbg="${pageContext.request.contextPath}/resources/img6/hero-2.jpg">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-5">
                            <span>Bag,kids</span>
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="single-banner">
                        <img src="${pageContext.request.contextPath}/resources/img6/banner-1.jpg" alt="">
                ...
                <div class="col-lg-4">
                    <div class="single-banner">
                        <img src="${pageContext.request.contextPath}/resources/img6/banner-2.jpg" alt="">
                        <div class="inner-text">
                            <h4>Womens</h4>
                        </div>
                    </div>
                ...
                <div class="col-lg-4">
                    <div class="single-banner">
                        <img src="${pageContext.request.contextPath}/resources/img6/banner-3.jpg" alt="">
                        <div class="inner-text">
                            <h4>Kids</h4>
                        </div>
                    </div>
    ...
    <section class="women-banner spad">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-3">
                    <div class="product-large set-bg" data-setbg="${pageContext.request.contextPath}/resources/img6/products/women-large.jpg">
                        <h2>Womens</h2>
                ...
                <div class="col-lg-8 offset-lg-1">
                    ...
                    <div class="product-slider owl-carousel">
                        <div class="product-item">
                            <div class="pi-pic">
                                <img src="${pageContext.request.contextPath}/resources/img6/products/women-1.jpg" alt="">
                        ...
                        <div class="product-item">
                            <div class="pi-pic">
                                <img src="${pageContext.request.contextPath}/resources/img6/products/women-2.jpg" alt="">
                                <div class="icon">
                                    <i class="fa fa-heart"></i>
                                </div>
                                <ul>
                        ...
                        <div class="product-item">
                            <div class="pi-pic">
                                <img src="${pageContext.request.contextPath}/resources/img6/products/women-3.jpg" alt="">
                                <div class="icon">
                                    <i class="fa fa-heart"></i>
                                </div>
                                <ul>
                        ...
                        <div class="product-item">
                            <div class="pi-pic">
                                <img src="${pageContext.request.contextPath}/resources/img6/products/women-4.jpg" alt="">
                                <div class="icon">
                                    <i class="fa fa-heart"></i>
                                </div>
                                <ul>
    ...
    <section class="deal-of-week set-bg spad" data-setbg="${pageContext.request.contextPath}/resources/img6/time-bg.jpg">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="product-slider owl-carousel">
                        <div class="product-item">
                            <div class="pi-pic">
                                <img src="${pageContext.request.contextPath}/resources/img6/products/man-1.jpg" alt="">
                                <div class="sale">Sale</div>
                                <div class="icon">
                                    <i class="fa fa-heart"></i>
                                </div>
                        ...
                        <div class="product-item">
                            <div class="pi-pic">
                                <img src="${pageContext.request.contextPath}/resources/img6/products/man-2.jpg" alt="">
                                <div class="icon">
                                    <i class="fa fa-heart"></i>
                                </div>
                                <ul>
                        ...
                        <div class="product-item">
                            <div class="pi-pic">
                                <img src="${pageContext.request.contextPath}/resources/img6/products/man-3.jpg" alt="">
                                <div class="icon">
                                    <i class="fa fa-heart"></i>
                                </div>
                                <ul>
                        ...
                        <div class="product-item">
                            <div class="pi-pic">
                                <img src="${pageContext.request.contextPath}/resources/img6/products/man-4.jpg" alt="">
                                <div class="icon">
                                    <i class="fa fa-heart"></i>
                                </div>
                                <ul>
                ...
                <div class="col-lg-3 offset-lg-1">
                    <div class="product-large set-bg m-large" data-setbg="${pageContext.request.contextPath}/resources/img6/products/man-large.jpg">
                        <h2>Mens</h2>
                        <a href="#">Discover More</a>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="single-benefit">
                            <div class="sb-icon">
                                <img src="${pageContext.request.contextPath}/resources/img6/icon-1.png" alt="">
                            </div>
                            <div class="sb-text">
                                <h6>Free Shipping</h6>
                    ...
                    <div class="col-lg-4">
                        <div class="single-benefit">
                            <div class="sb-icon">
                                <img src="${pageContext.request.contextPath}/resources/img6/icon-2.png" alt="">
                            </div>
                            <div class="sb-text">
